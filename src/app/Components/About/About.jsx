...
const About = ({ setplayVideo }) => {
  return (
    <>
      <div
        id="about"
        className=" max-[800px]:flex-col  max-[800px]:px-[5%] my-16  py-3 px-[3%] mx-auto w-[90%] flex items-center justify-between "
      >
        <div className="max-[800px]:w-[100%] max-[800px]:order-2 relative w-[60%] max-[900px]:w-[46%]">
          ...
          <div>
            <Image
              ...
              alt=""
              className=" absolute max-[800px]:w-[50px] w-[60px] top-[50%] right-[30%] max-[800px]:right-[40%] min-[900px]:right-[41%] -translate-x-[50%] -translate-y-[50%] cursor-pointer  "
              onClick={() => {
                setplayVideo(true);
              }}
            />
        ...
        <div className="max-[800px]:w-[100%] max-[900px]:w-[50%]  w-[36%]">
          <h2 className="text-xl  max-[1075px]:text-lg font-semibold text-[#150791fa]">
            ABOUT UNIVERSITY
          </h2>
