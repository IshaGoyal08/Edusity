    ...
    <div id='campus' className="max-[800px]:px-[5%] px-[10%]">
      ...
      <div className="text-center my-[70px] mx-auto w-[90%]">
        <div className="max-[800px]:flex-wrap flex items-center justify-between mb-[40px]">
          <img src="/images/gallery-1.png" alt="" className="w-[23%] rounded-lg max-[800px]:w-[48%] max-[800px]:mb-[20px]"/>
          <img src="/images/gallery-2.png" alt="" className="w-[23%] rounded-lg max-[800px]:w-[48%] max-[800px]:mb-[20px]"/>
          <img src="/images/gallery-3.png" alt="" className="w-[23%] rounded-lg max-[800px]:w-[48%] max-[800px]:mb-[20px]"/>
          <img src="/images/gallery-4.png" alt="" className="w-[23%] rounded-lg max-[800px]:w-[48%] max-[800px]:mb-[20px]"/>
        </div>
