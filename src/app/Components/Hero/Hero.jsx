  ...
  return (
    <div id='home' className='hero py-3 px-[10%] flex items-center justify-center w-full min-h-[100vh] bg-cover bg-center text-white' >
      <div className='text-center max-w-[800px] '>
        ...
        <button  className='bg-white inline-flex items-center justify-center gap-2 text-[#27272afa] px-4 py-2 text-md outline-none border-none rounded-3xl'>Explore more <img src="/images/dark-arrow.png" alt="" className='w-6 h-4 ' /></button>
      </div>
